...
await retry('published JavaScript bundle', async (attempt) => {
  ...
  if (!script.includes('VAL-012-UT2')) throw new Error('current UT2 ruleset marker is missing')
  if (!script.includes('action-chain-phase-v1')) throw new Error('current action-chain implementation marker is missing')
