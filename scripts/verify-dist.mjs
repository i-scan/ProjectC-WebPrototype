...
assert(script.includes('惯性实验室 · 双惯性 Sandbox'), 'UT4 Inertia Lab route is missing')
assert(script.includes('data-ruleset'), 'UT4 runtime ruleset hook is missing')
assert(script.includes('data-implementation'), 'UT4 runtime implementation hook is missing')
...
assert(script.includes('Event Log'), 'UT4 Event Log is missing')
...
assert(/\.ut4-board-frame/.test(style), 'UT4 board frame styling is missing from CSS')
