...
assert(script.includes('VAL-012-UT2'), 'phased action ruleset marker is missing')
assert(script.includes('action-chain-phase-v1'), 'action chain implementation marker is missing')
