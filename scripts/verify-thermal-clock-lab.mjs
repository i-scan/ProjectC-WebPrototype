...
try {
  ...
  assert(dom.includes('data-thermal-pendulum="skip-next-history-v3"'), 'Compact Thermal Pendulum marker missing')
  assert(dom.includes('data-thermal-zone-track="pendulum-arc-v2"'), 'Temperature zones must share the bob track')
  assert(dom.includes('data-thermal-pendulum-skip-arrow="next-at-v1"'), 'Skip next-AT pendulum arrow missing')
  assert(dom.includes('data-thermal-diagram="history-live-forecast-v2"'), 'Thermal Diagram marker missing')
  ...
  console.log('Thermal Clock browser smoke verified: compact Driving-style pendulum, Skip next-AT arrow, Thermal Diagram, live integer forecast markers, adjustable AT windows and existing Thermal controls are mounted.')
} finally {
