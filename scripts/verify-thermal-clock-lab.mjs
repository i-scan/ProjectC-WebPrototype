...
try {
  ...
  assert(dom.includes('data-thermal-dynamics-mode-switch="dual-mode-v1"'), 'Dual-mode switch missing')
  assert(dom.includes('data-thermal-inertial-rule="thermal-inertial-relaxation-v1-candidate"'), 'Inertial Relaxation rule marker missing')
  assert(dom.includes('Oscillator · Legacy') && dom.includes('Inertial Relaxation · Candidate'), 'Dual-mode labels missing')
