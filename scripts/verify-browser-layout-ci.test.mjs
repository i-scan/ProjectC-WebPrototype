...
describe('browser verification CI resilience', () => {
  it('routes historical Hex checks through the retry wrapper and verifies UT5, historical UT6, and live UT7 Basic Move', () => {
    ...
    expect(ut7).toContain('inertia-driving-basic-move-v2')
    expect(ut7).toContain('UT7 adjacent Basic Move target field')
    expect(ut7).toContain('UT7 one-AT Move Resolution preview')
    expect(ut7).toContain('UT7 one Basic Move command')
    ...
    expect(ut7).toContain('UT7 Basic Move verified in real Chrome')
  })
