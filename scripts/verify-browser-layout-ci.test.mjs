...
describe('browser verification CI resilience', () => {
  it('routes Hex checks through the transient-startup retry wrapper and then verifies UT4', () => {
    expect(packageJson.scripts['verify:browser']).toBe('node scripts/verify-browser-layout-ci.mjs && node scripts/verify-ut4-sandbox.mjs && node scripts/verify-ut4-interactions.mjs')
