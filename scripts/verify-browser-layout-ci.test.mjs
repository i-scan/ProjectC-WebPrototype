...
describe('browser verification CI resilience', () => {
  it('runs the click-to-resolve HexThreeBoard browser experiment through the Chrome startup retry wrapper', () => {
    ...
    expect(ut7).toContain('impulse-inertia-input-v3')
    expect(ut7).toContain('M0 Drive board-click commit')
    expect(ut7).toContain('persistent M1 Coast board-click commit')
    ...
    expect(ut7).toContain('Hybrid playback on original board')
    expect(ut7).toContain('same-hex-three-board-instance')
