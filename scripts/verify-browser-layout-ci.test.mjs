...
describe('browser verification CI resilience', () => {
  it('runs the click-to-resolve shared-board browser experiment through the Chrome startup retry wrapper', () => {
    ...
    expect(ut7).toContain('impulse-inertia-input-v2')
    ...
    expect(ut7).toContain('Hybrid playback on same board')
